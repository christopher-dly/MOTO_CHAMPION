...
use App\Repository\VehicleMaintenanceXLargeRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: VehicleMaintenanceXLargeRepository::class)]
class VehicleMaintenanceXLarge 
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function addVehicleMaintenance(VehicleMaintenance $vehicleMaintenance): self
    {
        if (!$this->vehicleMaintenance->contains($vehicleMaintenance)) {
            ...
            $vehicleMaintenance->setVehicleMaintenanceXLarge($this);
        }
    ...
    public function removeVehicleMaintenance(VehicleMaintenance $vehicleMaintenance): self
    {
        if ($this->vehicleMaintenance->contains($vehicleMaintenance)) {
            ...
            if ($vehicleMaintenance->getVehicleMaintenanceXLarge() === $this) {
                $vehicleMaintenance->setVehicleMaintenanceXLarge(null);
            }
        }
        return $this;
    }
