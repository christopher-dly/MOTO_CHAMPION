...
use App\Repository\VehicleMaintenanceMediumRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: VehicleMaintenanceMediumRepository::class)]
class VehicleMaintenanceMedium 
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(
        ...
        mappedBy: "vehicleMaintenanceMedium",
    ...
    public function addVehicleMaintenance(VehicleMaintenance $vehicleMaintenance): self
    {
        if (!$this->vehicleMaintenance->contains($vehicleMaintenance)) {
            ...
            $vehicleMaintenance->setVehicleMaintenanceMedium($this);
        }
    ...
    public function removeVehicleMaintenance(VehicleMaintenance $vehicleMaintenance): self
    {
        if ($this->vehicleMaintenance->contains($vehicleMaintenance)) {
            ...
            if ($vehicleMaintenance->getVehicleMaintenanceMedium() === $this) {
                $vehicleMaintenance->setVehicleMaintenanceMedium(null);
            }
        }
        return $this;
    }
