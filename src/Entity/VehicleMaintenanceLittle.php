...
use App\Repository\VehicleMaintenanceLittleRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: VehicleMaintenanceLittleRepository::class)]
class VehicleMaintenanceLittle 
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(
        ...
        mappedBy: "vehicleMaintenanceLittle",
    ...
    public function addVehicleMaintenance(VehicleMaintenance $vehicleMaintenance): self
    {
        if (!$this->vehicleMaintenance->contains($vehicleMaintenance)) {
            ...
            $vehicleMaintenance->setVehicleMaintenanceLittle($this);
        }
    ...
    public function removeVehicleMaintenance(VehicleMaintenance $vehicleMaintenance): self
    {
        if ($this->vehicleMaintenance->contains($vehicleMaintenance)) {
            ...
            if ($vehicleMaintenance->getVehicleMaintenanceLittle() === $this) {
                $vehicleMaintenance->setVehicleMaintenanceLittle(null);
            }
        }
        return $this;
    }
